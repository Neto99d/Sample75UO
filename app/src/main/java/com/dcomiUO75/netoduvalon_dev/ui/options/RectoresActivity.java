...
import com.dcomiUO75.netoduvalon_dev.ui.options.Adapters.RectorAdapter;
...
public class RectoresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageFull = findViewById(R.id.imageFullRector);
        fondoImageFull = findViewById(R.id.cardViewFullImageRector);
        mRecyclerView = findViewById(R.id.recycler_rectores);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mRecyclerView.setHasFixedSize(true);
        progressBar = findViewById(R.id.progressBarRectores);
                        ...
                        public void onResponse(Call<Data> callS, Response<Data> response) {
                            ...
                            if (response.isSuccessful()) {//si la peticion se completo con exito
                                ...
                                try {
                                    ...
                                    nAdapter = new RectorAdapter(rectores, mContext, imageFull, fondoImageFull);

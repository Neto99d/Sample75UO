...
import com.dcomiUO75.netoduvalon_dev.ui.modelsOdoo.ProfeEmerito;
import com.dcomiUO75.netoduvalon_dev.ui.options.Adapters.ProfeEmeritoAdapter;
...
public class ProfeMeritoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageFull = findViewById(R.id.imageViewFullEmerito);
        fondoImageFull = findViewById(R.id.cardViewFullImageEmerito);
        ...
        call.enqueue(new Callback<AccesOdoo>() {
            ...
            public void onResponse(Call<AccesOdoo> call, Response<AccesOdoo> response) {
                ...
                if (response.isSuccessful()) {//si la peticion se completo con exito
                    ...
                    ArrayList<ProfeEmerito> profeEmeritos = new ArrayList<>();
                    try {
                        OkHttpUtil.verificar();
                    } catch (Exception e) {
                        e.printStackTrace();
                    ...
                    Call<Data> callS = service.getProfeEmerito(params);
                            ...
                            if (response.isSuccessful()) {//si la peticion se completo con exito
                                ...
                                try {
                                    ...
                                    for (int i = 0; i < data.getData().size(); i++) {
                                        ProfeEmerito profeEmerito = new ProfeEmerito();
                                        profeEmerito.setContenido(data.getData().get(i).get("contenido").getAsString());
                                    ...
                                    nAdapter = new ProfeEmeritoAdapter(profeEmeritos, mContext, imageFull, fondoImageFull);
